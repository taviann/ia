...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	//Pro feature
		class Cozipress_testimonial_section_upgrade extends WP_Customize_Control {
			...
			?>
				<span class="customizer_CoziPress_testimonial_upgrade_section up-to-pro" style="display: none;"><?php _e('More Services Available in Testimonial Pro','cozipress'); ?></span>
