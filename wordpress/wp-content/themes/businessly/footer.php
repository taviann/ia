		...
		<div class="site-info">
			&copy;<?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?>
				...
				<span class="footer-info-right">
					<?php echo __(' | WordPress Theme by', 'businessly') ?> <a rel="nofollow" href="<?php echo esc_url('https://superbthemes.com/', 'businessly'); ?>"><?php echo __('Superbthemes.com', 'businessly') ?></a>
				</span>
