...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_value)){
        $value_err = "Please enter the value amount.";     
    ...
    if(empty($name_err) && empty($description_err) && empty($value_err) ){
        ...
        $sql = "UPDATE products SET name=?, description=?, value=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssii", $param_name, $param_description, $param_value, $param_id);
